...
export const T = {
  he: {
    ...
    // ── Share ──
    share: 'שתף',
    shareTitle: 'שתפו את הצ׳אט',
    shareHint: 'בחרו רשת, התמונה והטקסט כבר מוכנים',
    shareCopied: 'הועתק! הדביקו בפוסט',
    sharePreparing: 'מכין תמונה...',
    shareFailed: 'לא הצלחנו להכין תמונה, שיתוף הקישור בלבד',
    shareFomoText: 'תראו מה קורה עכשיו בצ׳אט הזה 👀🔥',
    shareNative: 'שיתוף מהיר',
  ...
  en: {
    ...
    // ── Share ──
    share: 'Share',
    shareTitle: 'Share the chat',
    shareHint: 'Pick a network, the image and text are ready',
    shareCopied: 'Copied! Paste it in your post',
    sharePreparing: 'Preparing image...',
    shareFailed: 'Could not prepare an image, sharing the link only',
    shareFomoText: 'Look what is happening in this chat right now 👀🔥',
